...
public class InventoryHandler {
    ...
    private boolean validateAction(KeyEvent event) {
        return event.getKeyCode() == KeyEvent.VK_Q || event.getKeyCode() == KeyEvent.VK_ENTER || event.getKeyCode() == KeyEvent.VK_UP || event.getKeyCode() == KeyEvent.VK_DOWN || event.getKeyCode() == KeyEvent.VK_DELETE;
    }
    ...
    public void setInventoryAction(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            ...
            case KeyEvent.VK_DELETE -> inventoryAction.updateState(Move.TAKE_OFF);
